public class Movie {
    ...
    public void watchMovie() {
        String instanceType = this.getClass().getSimpleName();/*This prints out the class, which will be movie if I execute this method on a runtime movie object.*/
...
class Comedy extends Movie {
    ...
    public void watchMovie() {
        super.watchMovie();
        System.out.printf(".. %s%n".repeat(3),"Funny Scene","Something funny Happens","Happy Ending");
    }
